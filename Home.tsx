...
const perguntasBase = [
  ...
  { id: 1, pergunta: 'DEFINA SEU GÊNERO:', 
  ...
  { id: 2, pergunta: 'QUAL O SEU TAMANHO DE ROUPA?', 
  ...
  { id: 3, pergunta: 'QUAIS CORES DE ROUPAS VOCÊ PREFERE?', 

    opcoes: 
    ['NEUTRAS (PRETO, BRANCO, CINZA)', 'CORES VIVAS', 'PASTÉIS', 'TONS TERROSOS', 'COLORIDO E VIBRANTE'] },




    
  { id: 4, pergunta: 'DESCREVA SUA PERSONALIDADE', 

    opcoesFeminino: 
    ['INFORMAL, ESPONTÂNEA, ALEGRE', 'CONSERVADORA, SÉRIA, ORGANIZADA', 'EXIGENTE, REFINADA, BEM-SUCEDIDA', 'FEMININA, MEIGA, DELICADA',
       'GLAMOROSA, EXCITANTE, SENSUAL', 'SOFISTICADA, MODERNA, FIRME', 'EXÓTICA, AVENTUREIRA, INOVADORA'], 
  ...
  { id: 5, pergunta: 'QUAL O SEU TIPO DE ROUPA FAVORITA?', 
    ...
    { id: 6, pergunta: 'QUAL VISUAL VOCÊ MAIS SE IDENTIFICA?',

     opcoesFeminino: 
     ['BÁSICO CONFORTÁVEL E PRÁTICO', 'FORMAL TRADICIONAL E ATEMPORAL', 'CLÁSSICO SOFISTICADO E ATUAL', 'DELICADO FEMININO E ROMÂNTICO',
     ...
     { id: 7, pergunta: 'QUAIS DETALHES VOCÊ MAIS GOSTA?', 

    opcoes: 
    ['LOOKS SEM DETALHES', 'DETALHES BEM DISCRETOS', 'DETALHES SOFISTICADOS', 'DETALHES DELICADOS', 'DETALHES QUE VALORIZAM O CORPO',
       'DETALHES MARCANTES', 'DETALHES DIFERENTES DO CONVENCIONAL'] },
    ...
    { id: 9, pergunta: 'QUAL SEU SAPATO FAVORITO?',
    ...
    { id: 10, pergunta: 'QUE TIPO DE ACESSÓRIOS VOCÊ GOSTA?', 

    opcoesFeminino: 
    ['ESPORTIVOS E SIMPLES', 'CLÁSSICOS E DISCRETOS', 'REFINADOS', 'DELICADOS E FEMININOS', 'GRANDES E BRILHANTES', 'DESIGN ARROJADO', 'DIVERTIDOS E RÚSTICOS'], 
    opcoesMasculino: 
    ['ESPORTIVOS E SIMPLES', 'CLÁSSICOS E DISCRETOS', 'REFINADOS', 'SIMPLES E MASCULINOS', 'GRANDES E MARCANTES', 'DESIGN ARROJADO', 'DIVERTIDOS E RÚSTICOS'] },
